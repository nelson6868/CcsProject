...
// import Rectangle69 from '../../assets/Rectangle69.svg';
...
const CloudSolution = ({ id, title, image, unit_price, rating, quantity, description, tenure, }) => {
    ...
    const getProductCategoriesData = () => {
        try {
            axios.get("https://sidcloud.azurewebsites.net/api/v1/products/get-category-details/", {
                // method: "GET",
    ...
    const getProductData = async () => {
        try {
            await axios.get("products/cloud-solutions/", {
                // method: "GET",
                // url: "https://catfact.ninja/fact",
            }).then(res => {
